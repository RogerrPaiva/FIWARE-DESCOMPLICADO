//Autor: Roger De Carvalho Paiva, Pedro Henrique Tavares Viana, David Ernesto Mogollon Gama
...
//AVISO: não esqueça de configurar a sua rede wifi e senha!

#include <WiFi.h>
#include <PubSubClient.h>

// Configurações - variáveis editáveis
const char* default_SSID = ""; // Nome da rede Wi-Fi
